...
'''
This is the GNU Radio PI_MODULATORS module. Place your Python package
...
# import swig generated symbols into the pi_modulators namespace
try:
    # this might fail if the module is python-only
    from .pi_modulators_swig import *
